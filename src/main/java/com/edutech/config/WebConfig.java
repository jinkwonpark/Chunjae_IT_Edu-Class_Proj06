...
public class WebConfig implements WebMvcConfigurer {
    // MainController에서 @GetMapping("/")를 사용하지 않고, /(루트)의 직접 위치 설정
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/").setViewName("index"); // WebMvcConfigurer랑 MainController 중 하나만 써주면 됨, 둘 다 쓰고 싶으면 똑같이 맞춰주기
    }
